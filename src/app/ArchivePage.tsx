...
import { getAllWeeks, categoryLabels } from "@/lib/data";
...
export default function ArchivePage({ initialArticles }: { initialArticles: Article[] }) {
  return (
    <Suspense fallback={
      ...
      <ArchiveContent articles={initialArticles} />
    </Suspense>
  );
}
